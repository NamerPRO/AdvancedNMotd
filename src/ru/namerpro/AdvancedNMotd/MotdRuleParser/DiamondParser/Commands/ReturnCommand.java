...
public class ReturnCommand implements IDiamondCommand {
    ...
    private ReturnCommand(int index, String lineToParse, DiamondVariables variables, RuleParser.RuleParserData parserData) {
        this.index = index;
    ...
    public static final class ReturnCommandFactory implements ICommandFactory {
        ...
        public IDiamondCommand create(int index, String lineToParse, DiamondVariables variables, RuleParser.RuleParserData parserData) {
            return new ReturnCommand(index, lineToParse, variables, parserData);
        }
    ...
    public Pair<String, Integer> execute() throws DiamondException {
        ...
        parserData.inputLine = stringCommandResponse.getKey();
        return new Pair<>(stringCommandResponse.getKey(), stringCommandResponse.getValue());
    }
